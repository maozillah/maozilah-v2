...
<p>I\'m also passionate about exploring the <em>ideal form</em> that a design should take. The answer is not always digital. Perhaps that is why I\'m so enthralled with data visualization. The data determines the final form. The process of panning for insights from millions of rows of data makes me <em>heady</em>.</p>
...
<p>I love reading books from around the world to compare their literary styles. Japanese writers tend to narrate in third person with a very matter of fact tone but interwoven with poetry. Russian writers like to tell you every. Single. Detail. For years. </p>

<p>Baking and cooking is a fascinating process of project management. How do you make sure dishes are ready at the same time when ingredients have different requirements? Cooking is my zen.</p>

<p>Drawing. At one point I thought I wanted to be an animator. It\'s taught me a lot about failing and perseverance. You can <a href="img/art.jpg" target="_blank">view some old artwork here</a>.</p>

<h1>I\'m seeking interaction design opportunities around the world.</h1>

<p>I believe that learning comes from many places, not just academic settings. I was born in China and moved to Canada at the age of 5. I am a boiling pot of two contrasting cultures. And that has made all the difference. </p>
