...
$content = '
<h1>Background</h1>
<p>On the Grow was designed and developed at <a href="https://2014.battlehack.org/" target="_blank">Battlehack Toronto</a>, a hackathon sponsored by Paypal. The requirement was that all ideas had to use paypal digital payment. </p>
...
<h1>Highlights</h1>
<p>There are two possible pathways for the app: buying or selling produce.</p>
...
<p>There are two views for finding produce: a map view and a list view. Our interviews with people indicated that <em>convenience</em> was an important factor when purchasing produce. The map view addresses this concern by providing a quick overview of available produce near the user.</p>
...
<h2>Sell produce</h2>
<p>Sell or donate your extra produce. Users can specify whether they\'d like payment in cash or through paypal.</p>
...
<p>When we shared our idea with them, they highlighted that convenience and the quality of the produce were major factors when grocery shopping.</p>
<div class="thumbnail">
...
<h2>Wireframming</h2>
<p>Wireframing was a very fast and collaborative effort due to the time contraints of a hackathon. I would quickly sketch out wireframes and iterate on the designs after discussing with the developers.</p>
<div class="thumbnail">
...
<figcaption>Pages on pages of wireframes.</figcaption>

<h2>Team photo</h2>
<p>This was the largest and most luxurious hackathon I\'ve attended. The energy and ideas present were really inspiring. The entire experience was a whirlwind of energy that challenged me to think quickly under pressure and prioritize. I\'m proud of the final product given the time and context.</p>
...
<p>One of the downsides of hackathons is the short amount of time available. As such, the quality of the design process suffers as a result.</p>
<ul>
	<li>The feasability of the app would have to be validated further through user interviews.</li>
	<li>Further research is required on locating home farmers. For example, downtown Toronto may not have enough  Waterloo </li>
	<li>A problem that we did not know how to circumvent was <strong>how to target immigrants</strong>. Many of homes that had gardens in Chinatown belonged to Chinese immigrants who only spoke chinese and may not own a smartphone.</li>
</ul>

<h2>Learnings</h2>
<ul>
	<li>Direct problem definition in the direction of design contraints. We should have focused on problems directly related to the mobile payment space.</li>
</ul>
';
?>