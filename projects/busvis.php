...
<p>Data was collected over the span of ~6 weeks at 6pm for 30 minutes. It was collected using a map of the bus stop area with a <strong>x</strong> for male, or <strong>v</strong> for female. Detailed notes were also recorded about the actions and interactions of the people in the space.</p>
<p>I didn\'t know exactly what I was looking for so I tried to collect information about everything. I refined the data I focused on as I saw trends emerge.</p>
<div class="thumbnail">
...
<p>After all the data was collected, I parsed it for patterns. I looked for interactions and behaviour that occurred frequently.</p>

<h2>Conceptualization</h2>
<p>I wanted to present a quick overview of my data as well as a detailed view. Explorations revolved around visualizing the geographic data.</p>
<div class="thumbnail">
...
<p>I created a grid to help me synthesize the pages of map data that I\'d collected. Numbers represent the number of people in each area while colours indicated activities.</p>
<div class="thumbnail">
...
<p>The data was then transferred to excel where it was ordered and calculations performed.</p>
<div class="thumbnail">
...
<p>Reflecting on this project now in 2015, there are many glaring issues that I see.</p>
<ul>
	<li>Far <strong>too many colours</strong> were chosen for visualizing the number of people. This makes it difficult to decipher the information communicated. As well, this granular level of data is unnecessary and does not add value to the visualization.</li>
	<li>The gradient indicates a continuous count for the people legend. But the numbers are not continuous which is misleading.</li>
	<li>The same colours were used to represent different elements such as people, temperature, weather. This is confusing as viewers perceive similar colours to represent similar elements.</li>
	<li>The integration and flow of the daily and map visualizations could have been addressed better visually.</li>
	<li>Labels should be provided indicating male or female for the map density by gender visualization.</li>
</ul>
';
?>